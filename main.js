...
const domModifier = (function() {
  ...
  const createTodoElement = function(todo) {
    ...
    if (todo.expanded === true) {
      ...
      try {
        ...
        dueDate.innerText = 'Due Date: ' + (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(new Date(todo.dueDate + 'T00:00:00'), 'MM/dd/yyyy');
  ...
  const editTodoSubmit = function(todo) {
    ...
    if (title === '' ) {
      ...
      _app__WEBPACK_IMPORTED_MODULE_2__.app.editTodo(todo, title, description, dueDate, priority);
      updateTodosDOM();  
    }
  }
